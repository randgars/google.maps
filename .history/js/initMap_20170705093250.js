...
function initialize() {
    ...
    document.getElementById('minDistance').addEventListener('click', calculateAndDisplayRoute);
    document.getElementById('minDuration').addEventListener('click', calculateAndDisplayRoute);
