...
function directionsRequest(directionsService, directionsDisplay, parts) {
    ...
    for (var i = 0; i < parts.length; i++) {
        ...
        directionsService.route({
            ...
            if (status === 'OK') {
                calculateMinDistance(minDistance, response.routes, totalDistance);
                directionsRendererFunction(response, minDistance, totalDistance);
            } else {
...
function calculateMinDistance(minDistance, routes, totalDistance) {
    debugger
...
function directionsRendererFunction(response, minDistance, totalDistance) {
