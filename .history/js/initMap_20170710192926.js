...
var geocoder,
    ...
    addWaypoints = document.getElementById('waypoints-input'),
...
function addValueToList() {
    ...
    if (addWaypoints.value) {
        locationList.push(addWaypoints.value);
    } else {
        return;
    }
