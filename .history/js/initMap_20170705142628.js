...
function initialize() {
    ...
    var onClickHandler = function () {
        ...
        calculateAndDisplayRoute(directionsService, directionsDisplay, map, this, geocoder);
    };
...
function calculateAndDisplayRoute(directionsService, directionsDisplay, map, obj, geocoder) {
