...
function calculateMinDistance(routes) {
    ...
    debugger
    minDistance = { distance: distanceValues[0], duration: routes[minDistance.index].legs[0].duration.value, index: 0 };
    ...
    fieldDurationValue.innerHTML = 'Duration: ' + routes[minDistance.index].legs[0].duration.value;
...
function calculateMinDuration(routes) {
    ...
    minDuration = { distance: routes[minDuration.index].legs[0].distance.value, duration: durationValues[0], index: 0 };
    ...
    fieldDistanceValue.innerHTML = 'Distance2: ' + routes[minDuration.index].legs[0].distance.value;
    fieldDurationValue.innerHTML = 'Duration2: ' + minDuration.duration;
